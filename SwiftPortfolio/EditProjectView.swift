...
//  SwiftPortfolio
//
//  Created by User23198271 on 2/3/21.
//
        ...
        Form {
            Section(header: Text("Basic Settings")) {
                ...
                Section(header: Text("Custom project color")) {
                    ...
                    Section(footer: Text("Closing a project moves it from the Open to Closed tab; deleting it removes the project completetly")) {
